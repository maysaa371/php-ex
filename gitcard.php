...
<?php foreach ($phones as $phone): ?>
  <div class="card">
    <img  style="width: 100px;height:100px" src="<?php echo $phone['img_url']; ?>" alt="<?php echo $phone['name']; ?>">
    <div class="card-body">
      <h5 class="card-title"><?php echo $phone['name']; ?></h5>
      <p class="card-text"><?php echo  $phone['brand']; ?></p>
      <p class="card-text"><?php echo $phone['price']; ?></p>
      <?php if ($phone['is_out_of_stock']): ?>
